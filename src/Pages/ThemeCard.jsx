        ...
        <div className="">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl py-1 sm:py-2 lg:max-w-none lg:py-3">
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Let's Customize Your Shopnix Store</h2>
              <h2 className="text-xl font-bold text-gray-900 mt-2 mb-2">Apply a theme</h2>

              <div className="mt-1 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0">
                {callouts.map((callout, index) => (
                  <div key={callout.name} className="group relative rounded-xl p-0.5 border-gray-300 border-2">
              ...
              <div className='flex justify-end'>
                <button
                  className={`button bg-blue-500 text-white font-semibold py-1.5 px-4 rounded-lg focus:outline-none focus:shadow-outline ${selectedThemeIndex ? '' : 'opacity-50 cursor-not-allowed'}`}
